...
@Component
public class ListarPedidosClienteEntreDatasUC {
    private final IPedidosRepository pedidosRepository;
    private final IAutenticacaoService authService;

    public ListarPedidosClienteEntreDatasUC(IPedidosRepository pedidosRepository, IAutenticacaoService authService) {
        this.pedidosRepository = pedidosRepository;
        this.authService = authService;
    }

    public List<PedidoResponse> run(String cpf, LocalDateTime inicio, LocalDateTime fim, String token) {
        ...
        return pedidosRepository.recuperarPorClienteEEntreguesEntreDatas(cpf, inicio, fim).stream()
